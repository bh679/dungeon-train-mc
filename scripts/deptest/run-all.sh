...
"$HERE/run-case.sh" "A - full set (positive control)"                  dt sable ain ais pmob ecp te kt db sff fp moon
"$HERE/run-case.sh" "B - missing AIN only"                             dt sable ais pmob ecp te kt db sff fp moon
"$HERE/run-case.sh" "C - missing all five siblings (upgrade path)"      dt sable fp moon
