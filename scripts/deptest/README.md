...
|---|---|---|
| **A** | DT + Sable + all six siblings + top-level DungeonBackup/SableFenceTrapdoorFix (CurseForge-app layout) | Server starts cleanly; prints `JarJar: nested copy skipped, mods/ copy wins` for both hybrid ids |
