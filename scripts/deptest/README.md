...
|---|---|---|
| **A** | DT + Sable + all five siblings + Fast Paintings + Moonlight + BetterNether and its three libraries + top-level KeepTrim/DungeonBackup/SableFenceTrapdoorFix (CurseForge-app layout) | Server starts cleanly; prints `JarJar: nested copy skipped, mods/ copy wins` for all three hybrid ids |
