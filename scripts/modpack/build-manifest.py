...
AIN/AIS/PlayerMob/EnderChestPersistence/TradeEverything/KeepTrim/DungeonBackup/SableFenceTrapdoorFix are un-bundled required downloads (so their own
project pages get credited), which means the pack must list them explicitly:
  ...
  * Each ``optional_mods`` entry — including the eight siblings, which carry
