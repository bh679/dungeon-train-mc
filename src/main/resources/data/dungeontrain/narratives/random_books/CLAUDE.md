...
Two characters do all the layout work. Same as narrative books.

| In JSON | Meaning | In rendered book |
|---|---|---|
| `\n` | Single line break | Forces a new line on the current page |
| `\n\n` | Paragraph break | **Becomes a new page** (flow paginator) |
...
> Practical consequence: **structure beats by paragraph.** Each `\n\n`-separated block is one page. Don't write long paragraphs unless you want them packed onto one page (or, if oversize, split unpredictably).
