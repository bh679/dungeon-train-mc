 ...
 */
public final class DimensionalCarriageContentsAllowStore {

    /**
     * All three paths come from {@link TrackKind#DIMENSIONAL_CARRIAGE} rather than being spelled out, so the
    ...
    private static final ContentsAllowStore STORE = new ContentsAllowStore(
        TrackKind.DIMENSIONAL_CARRIAGE.subdir(),
        TrackKind.DIMENSIONAL_CARRIAGE.bundledResourcePrefix(),
        TrackKind.DIMENSIONAL_CARRIAGE.sourceRelativePath());

    private DimensionalCarriageContentsAllowStore() {}
