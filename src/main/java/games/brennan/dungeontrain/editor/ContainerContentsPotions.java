 ...
 *
 * <p>Nothing here randomises. A potion entry spawns exactly the potion it stores; a random
 * potion is the separate {@code dungeontrain:random_potion} placeholder, baked by
