...
public enum TrainPhase {
     ...
     * name, so the ten phases read {@code O N V E U C S S B I}. A new phase is picked up automatically.
     */
    ...
    /** Parse a command token ({@code ow}/{@code overworld}/{@code nether}/{@code void}/{@code end}/{@code ud}/{@code upside_down}/{@code chuncks}/{@code spheres}/{@code stacks}/{@code beta}/{@code infdev}); null if unknown. */
