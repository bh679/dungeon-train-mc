...
/**
 * Fires when the player names a PlayerMob with a custom-named name tag.
 * Backs the <em>The Denamed</em> advancement — most passengers have
 ...
 * name-tag interaction; vanilla advancement dedupe keeps it to a single
 * grant per player.</p>
 *
 * <p>JSON shape:
 * <pre>{@code
 * { "trigger": "dungeontrain:named_playermob" }
 * }</pre>
 */
public final class NamedPlayerMobTrigger extends SimpleCriterionTrigger<NamedPlayerMobTrigger.Instance> {
