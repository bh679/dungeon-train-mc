 ...
 *   <li>{@code entered_dimensional_carriage} — stood in a dimensional carriage's body, past its corridor, for 5s</li>
 *   <li>{@code distant_portal_exit} — left a dimensional carriage by a corridor far from the way in</li>
 * </ul>
 *
 * <p>JSON shape:
 * <pre>{@code
