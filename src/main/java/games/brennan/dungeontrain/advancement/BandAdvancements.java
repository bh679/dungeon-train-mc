...
public final class BandAdvancements {
    ...
    public static final List<String> ALL = List.of(
            ...
            legacyId(LegacyBandKind.FLOATING), legacyId(LegacyBandKind.ALPHA), legacyId(LegacyBandKind.CLASSIC),
            legacyId(LegacyBandKind.INFDEV), legacyId(LegacyBandKind.SUPERFLAT), LEGACY_VOID,
            CHUNCKS, STACKS);
