...
/**
 * Keeps the dark from populating a dimensional carriage.
 *
 ...
 * Everything deliberate still works inside a dimensional carriage: a spawn egg, a command, a bucketed
...
public final class DimensionalCarriageSpawnGuard {

    private DimensionalCarriageSpawnGuard() {}
