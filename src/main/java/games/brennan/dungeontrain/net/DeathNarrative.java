 ...
 *
 * <p>Fields are {@code <page><Slot>} for the four narrative pages — fall,
 * deeds, lives, platform. The two survey pages ("the creator's ledger") are
 * NOT here: they come from the bundled Discord Presence survey system.</p>
 *
