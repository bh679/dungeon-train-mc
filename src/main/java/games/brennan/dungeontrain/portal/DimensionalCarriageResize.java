...
/**
 * Which face of a dimensional carriage a resize moves, and where the room's contents land afterwards.
 *
 ...
 * {@link DimensionalCarriageLayout#roomOrigin} anchors Y at the entry twin's own origin — and the doorways open
 ...
 * {@code DimensionalCarriageResizeMemory}.</p>
 */
public final class DimensionalCarriageResize {
    ...
    private DimensionalCarriageResize() {}
    ...
    public static int minOf(CarriageDims dims, Axis axis) {
        return switch (axis) {
            case LENGTH -> DimensionalCarriageLayout.MIN_LENGTH;
            case WIDTH -> DimensionalCarriageLayout.minWidth(dims);
            case HEIGHT -> DimensionalCarriageLayout.minHeight(dims);
        };
    }
     ...
     *
     * <p>{@code wanted} is taken as already clamped — {@link DimensionalCarriageLayout#clampSize} is the single
