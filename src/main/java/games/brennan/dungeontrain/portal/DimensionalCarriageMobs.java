...
/**
 * The mobs a dimensional carriage's variant sidecar asks for — spawning them, and taking them away again.
 *
 * <p>Room mobs used to be dropped with a warning, and the reason was sound: a dimensional carriage
 ...
 */
public final class DimensionalCarriageMobs {
    ...
    private DimensionalCarriageMobs() {}
     ...
     *
     * <ul>
     *   <li>it spawns as {@code MobSpawnType.SPAWN_EGG}, which {@link DimensionalCarriageSpawnGuard} does not
    ...
    public static boolean spawn(ServerLevel level, BlockPos worldPos, VariantState picked,
                                int pairKey, DimensionalCarriageTiling.Tile tile, long seed, int liveCount) {
    ...
    private static boolean belongsTo(Entity entity, int pairKey, DimensionalCarriageTiling.Tile tile) {
    ...
    static void mark(CompoundTag data, int pairKey, DimensionalCarriageTiling.Tile tile) {
    ...
    static boolean marks(CompoundTag data, int pairKey, DimensionalCarriageTiling.Tile tile) {
