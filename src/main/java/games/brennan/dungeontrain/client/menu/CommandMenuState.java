...
public final class CommandMenuState {
    ...
    public static void open() {
        // Anywhere in the editor world — or inside a plot elsewhere — with the X menu in screen
        // space, the inventory-style editor screen takes the whole surface; it is a Screen of its
        // own and never touches this stack. World-space, and screen-space outside the editor, keep
        // the row-list panel. See EditorScreenGate.
