...
public final class NewSourcePickerScreen implements MenuScreen {
    ...
    public enum Category {
        CARRIAGES, CONTENTS, PARTS, CHUNK_PARTS, TRACKS,
        /**
    ...
    @Override public String title() {
        return switch (category) {
            case PARTS, CHUNK_PARTS -> MenuLang.t("new_source.title_kind_source", kind);
    ...
    @Override public List<CommandMenuEntry> entries() {
        ...
        switch (category) {
            ...
            case CHUNK_PARTS -> {
                // Blank, or a copy of the chunk part being stood in. `enter` with a new name makes
                // it; the optional trailing name is the part it is copied from.
                String prefix = "dungeontrain editor chunkpart enter " + kind;
