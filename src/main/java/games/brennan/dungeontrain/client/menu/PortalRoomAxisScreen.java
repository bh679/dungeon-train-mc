...
/**
 * Type one number of a portal room's setup — an axis of its box, or how far apart its extra
 * corridors go.
 *
...
public final class PortalRoomAxisScreen implements MenuScreen {
     ...
     */
    public PortalRoomAxisScreen(String axis, String label, String unit, int current) {
        this.axis = axis;
        this.label = label;
        this.unit = unit;
