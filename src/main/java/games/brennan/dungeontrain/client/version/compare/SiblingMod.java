 ...
 * (DiscordPresence, EdibleBackpacks) update with DT and are deliberately absent. Keep Trim,
 * Dungeon Backup and Sable Fence &amp; Trapdoor Fix are un-bundled siblings too, but each joins
 * this enum only once its Modrinth listing is public — until then there is nothing to read a
 * latest version from.
 *
