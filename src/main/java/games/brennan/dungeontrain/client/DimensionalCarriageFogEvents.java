...
/**
 * Draws the fog that makes an endless dimensional carriage read as endless — the counterpart to
 * {@link NetherFogEvents} for the two tiling {@code DimensionalCarriageMode}s.
 *
...
public final class DimensionalCarriageFogEvents {

    private DimensionalCarriageFogEvents() {}
    ...
    public static void onRenderFog(ViewportEvent.RenderFog event) {
        ...
        // ClientDimensionalCarriageFog#fogDistanceAt — easing up from zero instead is what used to fill the
        // screen with fog colour for the first frames of a portal swap.
        float distance = ClientDimensionalCarriageFog.fogDistanceAt(
