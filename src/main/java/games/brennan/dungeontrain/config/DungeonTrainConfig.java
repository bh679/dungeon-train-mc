...
public final class DungeonTrainConfig {
    ...
    // TESTING default: 1 = a PlayerMob on every carriage group.
    // Pre-release TODO: change to 50 for the intended ~1-in-50 cadence.
    public static final int DEFAULT_PLAYER_MOB_SPAWN_ONE_IN = 1;
    ...
    private static Holder build(ModConfigSpec.Builder b) {
        ...
        ModConfigSpec.IntValue playerMobSpawnOneIn = b
                .comment("1-in-N chance that each settled carriage group spawns a PlayerMob (Interactive Player Mobs). 1 = a PlayerMob on every group (current testing default); 50 = ~1-in-50; 0 disables.")
