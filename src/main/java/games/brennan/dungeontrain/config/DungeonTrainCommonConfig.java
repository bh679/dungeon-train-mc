...
public final class DungeonTrainCommonConfig {
    ...
    public static final int DEFAULT_SPHERES_HOLD_BLOCKS = 7000;
     ...
     * last stretch — before v6 shrank it to 7000 and dropped the Nether sky. The v5 -> v6 migration
    ...
    private static Holder build(ModConfigSpec.Builder b) {
        ...
        ModConfigSpec.IntValue spheresHoldBlocks = b
                .comment("Blocks of spheres-band world-gen (the whole void-with-spheres stretch). Default 7000.")
    ...
    public static void runPendingMigrations() {
        ...
        // v5 -> v6: the spheres band shrank to 7000 (entry fade 750) with its progression moved earlier, and
