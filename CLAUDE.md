...
- **Key Dependency:** Sable (`2.0.3+mc1.21.1`) — provides moving ship/train physics. NeoForge-only (PolyForm Shield 1.0.0 licence). Replaced Valkyrien Skies 2 in Phase 2 of the 1.21.1 migration; see `build.gradle` for the jarJar extraction setup.
